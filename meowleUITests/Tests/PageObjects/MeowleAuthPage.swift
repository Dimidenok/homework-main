...
private extension String {
    ...
    static let authViewControllerScreenIdentifier = "authScreenViewController"
}
...
final class MeowleAuthPage: BasePage {
    ...
    private lazy var authTitle = app.staticTexts[.title]
    private lazy var authScreen = app.otherElements[.authViewControllerScreenIdentifier]
    ...
    @discardableResult
    func assertAuthTitle() -> MeowleAuthPage{
        XCTAssertTrue(authTitle.waitForExistence(timeout: .timeout))
        return self
    }
